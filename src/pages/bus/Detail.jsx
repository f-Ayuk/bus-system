        ...
        <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 mt-[13ch] mb-[10ch]'>
            <div className="w-full grid grid-cols-2 gap-16 items-center">
                <div className="col-span-1 space-y-8">
                    <img src={Bus9} alt="detail img" className="w-full aspect-[3/2] rounded-md object-contain" />
                    <div className="space-y-4">
                        ...
                        <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit cupiditate mollitia corporis. Officia ipsa illum quam asperiores, totam tempore. Amet veniam reiciendis adipisci, iusto totam facilis delectus voluptatibus nesciunt necessitatibus.    
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora cum qui omnis harum labore? Laboriosam, expedita tenetur? Deserunt alias minima porro adipisci, deleniti id magni, nostrum ipsam vero excepturi perferendis!
                        </p>
                    </div>
                </div>
