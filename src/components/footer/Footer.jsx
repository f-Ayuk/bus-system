      ...
      <div className="grid grid-cols-5 gap-5">
        <div className="space-y-5 col-span-2">
          ...
          <p className="text-neutral-600 dark:text-neutral-500 text-base font-normal pr-10">
            With many years of experience, dynamism and professionalism, the company remain a leader in the transportation Industry in Cameroon,
            providing a wide range of services to its customers. 
          </p>
        </div>
