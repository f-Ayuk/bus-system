...
const Seat = ({ seatNumber, isSelected, onClick }) => {
    return (
        <MdOutlineChair className={`text-3xl -rotate-90 cursor-pointer ${
...
const BusSearchLayout = ( { seatPrice = 750 }) => {
    const totalSeats = 41;
            ...
            <div className='space-y-5'>
                ...
                <div className="w-full flex justify-between">
                    ...
                    <div className="space-y-3 w-28">
                        ...
                        <div className="flex items-center gap-x-2">
                            <MdOutlineChair className='text-lg text-red-neutral-500 -rotate-90' />
                            <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal">
                                Booked
                            </p>
                        </div>
                        ...
                        <div className="flex items-center gap-x-2">
                            <MdOutlineChair className='text-lg text-violet-neutral-500 -rotate-90' />
                            <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal">
                                Selected
                            </p>
                        </div>
